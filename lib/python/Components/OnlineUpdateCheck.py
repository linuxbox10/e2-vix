...
class FeedsStatusCheck:
	...
	def getFeedsErrorMessage(self):
		...
		if self.feedstatus == -2:
			...
			return _("Your %s %s is not able to connect to the feeds, please try again later. If this persists please report at vuplus-images.co.uk.") % (getMachineBrand(), getMachineName())
